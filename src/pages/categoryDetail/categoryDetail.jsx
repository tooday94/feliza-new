...
function CategoryDetail() {
  ...
  const { data: categoryList } = useGetList(
  ...
  if (isLoading && page === 0) {
    return (
      <div
        ...
        className="max-w-[1280px] mx-auto flex justify-between gap-3 overflow-x-scroll overflow-hidden"
      >
  ...
  return (
    <div className="max-w-[1280px] mx-auto px-4 py-8 font-tenor">
      ...
      <p className="mb-6 text-gray-600">
        {i18n.language === "uz"
          ? `Jami mahsulotlar soni: ${totalProducts} ta`
          : i18n.language === "ru"
          ? `Всего товаров: ${totalProducts} шт`
      ...
      {hasMore && (
        <div className="flex justify-center mt-10">
          <button
            ...
            className="py-2 px-16 border border-primary cursor-pointer hover:bg-primary hover:text-white transition-colors duration-500"
            disabled={isFetching}
          >
            {i18n.language === "uz"
